This is a 2D minigame creating for the University of Maryland Game Development Club.

The club was hosting a game jam where members would end up creating a game in the style of Warioware, where each team
    creates a game, using arrow keys, WASD, and the spacebar as the entire control system.
The product attached was developed in less than 24 hours, with me creating the sprites and the scripts. A partner of mine
    provided the background music for the game, although they do not have a GitHub account associated with the project.
